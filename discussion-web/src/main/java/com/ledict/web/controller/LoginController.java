...
import com.ledict.core.util.VerifyCodeUtil;
import com.ledict.entity.*;
...
public class LoginController extends BaseController {
	...
	@ResponseBody
	@SysLog("用户登录")
	public Object loginMain(HttpServletRequest request,HttpServletResponse response) {
...
//		if(StringUtils.isBlank(code) || !trueCode.toLowerCase().equals(code.toLowerCase())){
		...
		if("true".equals(ieType)){
			System.out.println("IE浏览器");
		}else{
			System.out.println("非IE浏览器");
		}
