...
<fieldset class="layui-elem-field">
    ...
    <form class="layui-form">
        ...
        <div class="layui-input-inline">
            <a class="layui-btn" lay-submit="" lay-filter="searchForm"><i class="fa fa-search">&nbsp;</i>查询</a>
        </div>
        <div class="layui-inline">
            <a class="layui-btn layui-btn-normal" data-type="addUser"><i class="fa fa-plus">&nbsp;</i>添加角色</a>
        </div>
        <div class="layui-inline">
            <a class="layui-btn layui-btn-danger" data-type="deleteSome"><i class="fa fa-trash">&nbsp;</i>批量删除</a>
        </div>
    </form>
    </div>
</fieldset>
