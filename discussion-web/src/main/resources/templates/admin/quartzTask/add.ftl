...
<form class="layui-form" style="width:80%;">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input  type="text"  class="layui-input cron layui-input-disabled" name="cron" id="cron"  placeholder="点击选择Cron表达式" data-type="openCron"/>
        </div>
    </div>
    <div class="layui-form-item">
        ...
        var active={
            openCron : function(){
                var cronFrame =layer.open({
                    ...
                    btn: ['确定'],
                    moveType: 1,
                    content: '${base}/admin/quartzTask/openCron',
