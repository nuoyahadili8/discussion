package com.ledict.core.aspect;

import com.alibaba.fastjson.JSONObject;
import com.ledict.core.base.MySysUser;
import com.ledict.core.exception.GlobalExceptionHandler;
...
public class WebLogAspect {
    ...
    @Pointcut("@annotation(com.ledict.core.annotation.SysLog)")
    public void webLog(){}
    ...
    public void doBefore(JoinPoint joinPoint) {
        ...
        com.ledict.core.annotation.SysLog mylog = method.getAnnotation(com.ledict.core.annotation.SysLog.class);
        if(mylog != null){
            //注解上的描述
